...
def prepare_dataset_L_from_csv(dataset_L_path, csv_file, output_path, train_ratio=0.8):
    """
    Prepare dataset directly from CSV file
    Rotate images to match CSV annotation coordinates if needed (no augmentation)
    """
...
if __name__ == "__main__":
    prepare_dataset_L_from_csv(
        ...
        output_path="./datasets/dataset_L_coco_norot",
        train_ratio=0.8
    )
    print("\nDataset L preparation (no rotation) complete!")
