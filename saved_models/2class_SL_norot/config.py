...
class Config(MyConfig):
    def __init__(self):
        ...
        # 2-class dataset (no rotation)
        self.dataset.train_ann = ('2class_norot_train_coco', )
        self.dataset.val_ann = ('2class_norot_val_coco', )
        ...
        # Class names: S (class 0), L (class 1)
        self.dataset.class_names = ['S', 'L']
